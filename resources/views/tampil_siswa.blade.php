            ...
            <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
                ...
                <div class="card shadow p-2">
                    ...
                    <div class="table m-4" style="color: black">
                        @if ($siswa_id)
                            <div class="grid" style="display: grid; gap: 4px; grid-template-columns: 2fr 9fr; font-size: 1rem; font-weight: 600">
                        ...
                        <div class="message mt-4" style="font-weight: 800; font-size: 1rem">
                            <div class=" btn-warning btn-circle btn-sm mr-2" style="display: inline-flex; justify-content: center; align-items: center;">
                                <i class="fas fa-exclamation-triangle" style="background-color: transparent; color: black"></i>
                            </div>
                        ...
                        <div class="progres mt-4 mb-2" style="font-weight: 800">
                            ...
                            <div class="grid" style="display: grid; gap: 4px; grid-template-columns: 2fr 9fr;">
