            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion p-2" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2"
                    ...
                    <div class="sidebar-brand-icon">
                        <img src="{{ asset('icon/android-icon-48x48.png') }}" style="border-radius: 30%" alt=""
                            srcset="">
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{ route('daftar.leaderboard') }}">Leaderboard Siswa</a>
                            <a class="collapse-item" href="{{ route('daftar.siswa') }}">Daftar Siswa</a>
                            <a class="collapse-item" href="{{ route('daftar.progres') }}">Progres Siswa</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- Nav Item - Charts -->
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('daftar.soal') }}">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        @if (session('success'))
                            <div id="alert-success" class="alert alert-success"
                                style="display: flex; position: absolute; top: 4rem; left: 50%; transform: translateX(-50%); z-index: 1000; align-items: center;">
                                {{ session('success') }}
                            </div>
                        @endif
                        @if ($errors->any())
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    aria-labelledby="userDropdown" style="background-color: red">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Leontino 2023</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
