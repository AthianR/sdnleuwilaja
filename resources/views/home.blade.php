                    ...
                    <div class="card-body">
                        <h4 class="small font-weight-bold">
                            ...
                            <span class="float-right">
                                @foreach ($progresIpa as $item)
                                    {{ number_format(($item->total_progres / ($countSiswa * 6)) * 100, 0) }}%
                                @endforeach
                            </span>
                        </h4>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-danger" role="progressbar"
                                style="width: {{ number_format(($item->total_progres / ($countSiswa * 6)) * 100, 0) }}%"
                                aria-valuenow="{{ number_format(($item->total_progres / ($countSiswa * 6)) * 100, 0) }}%"
